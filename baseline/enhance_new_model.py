...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", "-m", help="ONNX model to use for inference.", default="best_model_converted.onnx")
    ...
    for mic_path in tqdm(mic_paths):
        ...
        new_basename = "mic_new.wav"
        out_path = os.path.join(args.output_dir, new_basename)
